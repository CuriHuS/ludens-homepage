...
export const metadata: Metadata = {
  metadataBase: new URL('https://ludens.kr'), // 루덴스 홈페이지 주소 --> 실제 배포 시 변경
  title: {
    default: '루덴스',
    template: '%s | 루덴스'
  },
  ...
  openGraph: {
    ...
    type: 'website',
    locale: 'ko_KR',
    url: 'https://ludens.kr', // 루덴스 홈페이지 주소 --> 실제 배포 시 변경
    siteName: '루덴스',
  },
  twitter: {
  ...
  //   naver: 'your-naver-site-verification',   // Add your Naver verification code if needed
  // }
};
