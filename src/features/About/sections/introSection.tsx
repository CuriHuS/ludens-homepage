...
export default function IntroSection() {
  return (
    <section className="flex flex-col items-center mt-64">
      <p className="mb-8 text-3xl font-semibold text-white">열정으로 이루는 도전, 성장</p>
      <p className="mb-16 max-w-4xl text-lg text-center font-semibold text-white">
        루덴스는 경희대학교 소프트웨어융합학과 게임콘텐츠트랙 학생들이 모여 시작한 동아리입니다. <br></br>기획, 디자인, 개발 등 게임의 전반적인 과정을 경험할 수 있으며, 부원들이 열정을 가지고 성장할 수 있도록 지원합니다.
      </p>
          ...
          >
            {({ countUpRef }) => (
              <div className="flex flex-col items-center justify-center bg-neutral-800 rounded-xl p-8 w-full aspect-[2/1]">
                <p className="text-base md:text-lg text-white font-semibold mb-1">{title}</p>
