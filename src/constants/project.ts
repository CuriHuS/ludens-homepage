...
export const PROJECT_LIST: Project[] = [
  ...
  },
  {
    ...
    teamMembers:
      "최현승(소융20), 허건호(소융21), 김수연(소융22), 신동준(소융23)",
  ...
  },
  {
    ...
    teamMembers:
      "김채연(소융21), 송인서(소융21), 조소연(소융21), 한세은(소융21), 허건호(소융21)",
    description: "",
    techStack: ["Unity", "Git"],
    links: [
      {
  ...
  },
  {
    ...
    teamMembers:
      "최현승(소융20), 권신혁(소융23), 김수은(소융23), 송예린(소융23)",
  ...
  },
  {
    ...
    teamMembers:
      "김채연(소융21), 송인서(소융21), 한세은(소융21), 허건호(소융21)",
    description: "",
    links: [
      {
        type: "youtube",
  ...
  },
  {
    ...
    teamMembers:
      "김채연(소융21), 조소연(소융21), 한세은(소융21), 허건호(소융21)",
    description: "",
    links: [
      {
        type: "youtube",
